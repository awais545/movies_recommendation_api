...
# up coming movies
Movie.create title: "Foo",        release_year: Date.today.year + 1, genres: [ "Cartoon" ]
Movie.create title: "Bar",        release_year: Date.today.year + 1, genres: [ "Comedy" ]
Movie.create title: "Helloworld", release_year: Date.today.year + 1, genres: [ "Adventure" ]
